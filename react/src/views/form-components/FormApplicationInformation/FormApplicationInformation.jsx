                            ...
                            <div className="col-12 d-flex">
                                ...
                                <p className="container-fluid fw-bolder">AGREEMENT:</p>
                                    ...
                                    <label className="form-check-label">
                                        I hearby approve that the information I
                                        gave in this form is correct and I agree
                                        that if somehow the information I gave
                                        is fake, KPTM/KUPTM Kuala Lumpur can
                                        legally reject my application, and
                                        revert back any offer or terminate my
                                        study in Kolej Poly-Tech Mara/ Kolej
                                        Universiti Poly-Tech MARA (KUPTM) Kuala
                                        Lumpur at any given time
                                    </label>
                                </div>
                            </div>
                        </div>

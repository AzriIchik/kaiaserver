                ...
                <a
                  ...
                  href={`/application?ID=${
                    localStorage.getItem("STAFFID")
                      ? localStorage.getItem("STAFFID")
                      : import.meta.env.VITE_DEFAULT_STAFF_ID
                  }`}
                >
                  Application
                </a>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <a
                      className="dropdown-item"
                      href="https://bpahat.kptm.edu.my/index.php/ms/"
                      target="_blank"
                    >
                      Batu Pahat
                    </a>
                  ...
                  <li>
                    <a
                      className="dropdown-item"
                      href="https://ipoh.kptm.edu.my/index.php/ms/"
                      target="_blank"
                    >
                      Ipoh
                    </a>
                  ...
                  <li>
                    <a
                      className="dropdown-item"
                      href="https://sp.kptm.edu.my/index.php/en/"
                      target="_blank"
                    >
                      Kuantan
                    </a>

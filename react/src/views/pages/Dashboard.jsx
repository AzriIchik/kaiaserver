  ...
  return (
    <>
      ...
      <main className="page-content position-relative">
            ...
            <div className="card overflow-hidden radius-10">
              <div className="card-body">
                <div className="d-flex align-items-stretch justify-content-between overflow-hidden">
                  ...
                  <div className="w-50">
                    <p className="mb-3 float-end text-success">2 Applicator</p>
                    <div id="chart2"></div>
                  </div>
                </div>
              </div>
            ...
            <div className="card overflow-hidden radius-10">
              <div className="card-body">
                <div className="d-flex align-items-stretch justify-content-between overflow-hidden">
                  ...
                  <div className="w-50">
                    <p className="mb-3 float-end text-danger">2 Applicator</p>
                    <div id="chart3"></div>
                  </div>
                </div>
              </div>
        ...
        <section className={viewApplicationDetails ? "d-none" : "d-block"}>
          <div className="row">
            <div className="col-12 col-lg-12 col-xl-8 d-flex">
              <div className="card radius-10 w-100">
                <div className="card-body">
                  <div className="d-flex align-items-center py-2">
                    <h6 className="mb-0">Application List</h6>
                  </div>
                ...
                <div className="card-body">
                  ...
                  <div className="traffic-widget">
                    <div className="progress-wrapper">
                      <p>kaia.azriperisiben.online/application?ID=FP03598</p>
                      <div>
                        <div className="d-flex align-items-center gap-3 fs-6">
                          <span className="fw-bold">Share referal link:</span>
                          <a
    ...
    <table className="table align-middle mb-0 table-hover hover-cursor">
      ...
      <tbody>
        {applicationList.map((application) => {
          let { application_id, name, mobilephoneno, housephoneno, email } =
            application;
          ...
          return (
            ...
            >
              ...
              <td>Apr 8, 2021</td>
              <td>
                <a className="d-block" href={"tel:" + mobilephoneno}>
                  {mobilephoneno}
                </a>
              </td>
              <td>
                <a href={"tel:" + housephoneno}>{housephoneno}</a>
              </td>
              <td>
                <a href="mailto:azriperisiben96@gmail.com">{email}</a>
              </td>
            </tr>
          );
        })}

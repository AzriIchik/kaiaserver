...
const Application = () => {
  const { viewApplicationDetails } = useContext(AppContext);
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h2>
                This system is still in development phase, and should be treated
                as prototype and not a fully functional system. Additionally it
                is not a system owned by Kolej Poly-Tech Mara Sdn Bhd (KPTMSB),
                and currently used as a demonstartion to introduce a new use of
                technology in business proccess for KPTMSB in
                innovation competition 2023 (VICE 2023)
                <div className="mt-5">
                  To enquire more please contact (En Azri bin Perisiben) at{" "}
